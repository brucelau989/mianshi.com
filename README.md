...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .header::before {
    ...
    inset: 0;
    background:
      repeating-linear-gradient(90deg, transparent, transparent 40px, rgba(200,150,62,.06) 40px, rgba(200,150,62,.06) 41px),
      repeating-linear-gradient(0deg,  transparent, transparent 40px, rgba(200,150,62,.06) 40px, rgba(200,150,62,.06) 41px);
  }
  .header-badge {
  ...
  /* ── NOTICE ── */
  .notice-bar {
    background: linear-gradient(90deg, #7A1A1A, #C0392B, #7A1A1A);
    color: #FFD5D5;
    text-align: center;
    padding: 9px 20px;
    font-size: 12px;
  ...
  .tab-row {
    ...
    overflow: hidden;
    margin-bottom: 24px;
    box-shadow: 0 2px 8px rgba(200,150,62,.08);
  }
  .tab-btn {
    flex: 1;
    padding: 13px 10px;
    ...
    transition: all .2s;
    letter-spacing: 1px;
    border-right: 1.5px solid #E0D0B0;
  }
  ...
  .step-line {
    ...
    flex: 1;
    min-height: 24px;
    background: linear-gradient(to bottom, #D4B896 60%, transparent);
    margin: 4px 0;
  }
  ...
  .step-card {
    ...
    padding: 15px 17px;
    margin-top: 2px;
    box-shadow: 0 2px 8px rgba(200,150,62,.06);
  }
  .step-top {
    display: flex;
    align-items: center;
  ...
  .step-desc { font-size: 13px; color: var(--ink-light); line-height: 1.9; }
  .step-desc strong { color: var(--ink-mid); }
  .step-actions { display: flex; flex-wrap: wrap; gap: 8px; margin-top: 11px; }
  .action-pill { font-size: 11px; padding: 4px 13px; border-radius: 20px; font-weight: 500; letter-spacing: .5px; }
  ...
  .branch-title { font-size: 11px; font-weight: 700; color: var(--gold); letter-spacing: 1px; margin-bottom: 8px; }
  ...
  .bi-name { font-weight: 700; color: var(--ink-mid); font-size: 12px; margin-bottom: 2px; }
  .bi-info { color: var(--ink-faint); font-size: 10px; line-height: 1.7; }
  .bi-status { display: inline-block; font-size: 9px; padding: 2px 7px; border-radius: 3px; margin-top: 5px; font-weight: 600; }
  ...
  .class-tag  { font-size: 9px; letter-spacing: 2px; color: rgba(255,255,255,.55); display: block; margin-bottom: 4px; }
  .class-name { font-family: 'Noto Serif SC',serif; font-size: 19px; font-weight: 900; color: var(--white); display: block; }
  ...
  .class-count .unit { font-size: 10px; color: rgba(255,255,255,.45); }

  .class-body { padding: 13px 16px 15px; }
  .class-price { font-size: 13px; color: var(--ink-faint); margin-bottom: 9px; font-family: 'Noto Serif SC',serif; }
  .class-price span { font-size: 24px; font-weight: 900; color: var(--red); font-family: Georgia,serif; letter-spacing: -1px; }
  .class-feature { font-size: 12px; color: var(--ink-light); line-height: 1.95; }
  ...
  .tip-item {
    background: var(--white); border: 1px solid #E8DCC8; border-radius: 8px;
    padding: 13px 14px; display: flex; gap: 10px; align-items: flex-start;
  }
  .tip-icon { width: 30px; height: 30px; border-radius: 7px; display: flex; align-items: center; justify-content: center; font-size: 15px; flex-shrink: 0; }
  .tip-text { font-size: 12.5px; color: var(--ink-light); line-height: 1.85; }
  ...
  .promo-card {
    border-radius: 11px; padding: 17px 16px;
    display: flex; gap: 13px; align-items: flex-start;
    position: relative; overflow: hidden;
  }
  .promo-card::after {
    content: ''; position: absolute; right: -22px; bottom: -22px;
    width: 88px; height: 88px; border-radius: 50%; opacity: .09;
  }
  ...
  .promo-icon  { font-size: 26px; flex-shrink: 0; line-height: 1; margin-top: 2px; }
  .promo-title { font-family: 'Noto Serif SC',serif; font-size: 14px; font-weight: 700; color: var(--ink); margin-bottom: 7px; }
  .promo-desc  { font-size: 12px; color: var(--ink-light); line-height: 2; }
  ...
  .promo-example {
    ...
    padding: 5px 9px; background: rgba(0,0,0,.05);
  ...
  .promo-tag {
    ...
    background: rgba(0,0,0,.07); color: var(--ink-mid);
  }
  ...
  .footer {
    ...
    border-top: 1px solid #E8DCC8; margin-top: 10px; letter-spacing: 1px;
  }
...
<div class="header">
  ...
  <div class="header-meta">
    <span><span class="dot"></span>成绩公布：3月17日 09:00</span>
    <span><span class="dot"></span>培训开班：3月17日下午</span>
    <span><span class="dot"></span>地点：酒店房改教室</span>
  </div>
</div>
...
<div class="main">
  ...
  <div class="tab-row">
    <button class="tab-btn active" onclick="switchTab('student')">📋 学生报名流程</button>
    <button class="tab-btn"        onclick="switchTab('class')">📚 班次对比选择</button>
  </div>
...
function switchTab(name) {
  ...
  const idx = ['student','class'].indexOf(name);
